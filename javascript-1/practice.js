...
myNumbers.forEach((value, index) => myNumbersIndex.push(index))
...
// Code Here
let forTheLoveOfGeorge = notGeorge.map((names) => names = 'George')
...
// Code Here
let totallyAwesome = people.reduce((total, num) => total + num.awesomeLevel, 0)